...
plt.setp(frame.axes.get_yticklabels(), visible=False)
frame.axes.get_xaxis().set_ticks([-0.002, -0.001, 0, 0.001, 0.002, 0.003, 0.004])
frame.axes.get_xaxis().set_ticklabels(['-0.002', '-0.001', '0', '0.001', '0.002', '0.003', '0.004'])
xlabel("$\Delta$")
...
absdelta.sort()
upperlimit = int(0.95*size)
print '(delta) 95\% limit:', normbk1
print 'abs(delta) 95\% limit:', absdelta[upperlimit]
